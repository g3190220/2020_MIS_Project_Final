...
class Caculate2 extends React.Component{
    state = {
    }
    constructor(props) {
        super(props)
    ...
    Caculator(){
        if(this.state.selected==1){
            ...
            this.setState({o1:"目標投資年報酬率",a1:(_return*100)+"%"})
            this.setState({o2:"投資期間",a2:_period+"年"})
            ...
            var _return=0;
            //取得rate資料
            const url = "https://ncufundu.ddns.net:8090/CalculateRate";
            fetch(url, {
                method: 'POST',
                headers: {
            ...
            .then(()=>{
                ...
                this.setState({o2:"投資期間",a2:_period+"年"})
                this.setState({o3:"期末金額",a3:_total+"元"})
                this.setState({o4:"您年報酬率須為：",a4:_return+"%"})
            })
            ...
            this.setState({o1:"投資金額",a1:_cost+"元"})
            this.setState({o2:"投資期間",a2:_period+"年"})
            this.setState({o3:"目標投資年報酬率",a3:_return+"%"})
            ...
            this.setState({show:"visible"})
            this.setState({o1:"投資金額",a1:_cost+"元"})
            this.setState({o2:"目標投資年報酬率",a2:(_return*100)+"%"})
            this.setState({o3:"期末金額",a3:_total+"元"})
            this.setState({o4:"您的投資期間須為：",a4:_period+"年"})
                ...
                <Row>
                    <Col sm={6}>
                            <table id="dollor-table">
                                ...
                                <tr>
                                    <input style={{"width":"180px",color:this.state.answer_period}} type="number" name="1" min="1" max="100000000000" required disabled={this.state.selected==4} onChange={this.handleChange2('period')} value={this.state.period}></input> 年
                                </tr>
                                <tr>
                                    目標投資年報酬率
